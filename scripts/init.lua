...
--Tracker:AddLocations("locations/submaps_johto_cities.json")
--Tracker:AddLocations("locations/submaps_Johto_Routes.json")
--Tracker:AddLocations("locations/submaps_johto_dungeons.json")
--Tracker:AddLocations("locations/submaps_kanto_cities.json")
--Tracker:AddLocations("locations/submaps_kanto_Routes.json")
--Tracker:AddLocations("locations/submaps_kanto_dungeons.json")
